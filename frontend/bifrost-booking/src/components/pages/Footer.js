            ...
            <div className="container mx-auto flex flex-wrap justify-between">
                ...
                <div className="w-full md:w-1/4 mb-4">
                    ...
                    <ul>
                        ...
                        <li><a href="/search" className="text-sky-300 hover:text-moss-600 transition duration-300">Flights</a></li>
                        <li><a href="/register" className="text-sky-300 hover:text-moss-600 transition duration-300">Register</a></li>
                        <li><a href="/login" className="text-sky-300 hover:text-moss-600 transition duration-300">Login</a></li>
                    </ul>
                </div>
                ...
                <div className="w-full md:w-1/4 mb-4">
                    ...
                    <ul>
                        <li><a href="#" target="_blank" className="text-sky-300 hover:text-salmon-500 transition duration-300">Twitter</a></li>
                        <li><a href="#" target="_blank" className="text-sky-300 hover:text-salmon-500 transition duration-300">Facebook</a></li>
                        <li><a href="#" target="_blank" className="text-sky-300 hover:text-salmon-500 transition duration-300">Instagram</a></li>
