...
// const airlines = [
//     'American Airlines', 'Delta', 'United', 'Southwest', 'Air Canada',
//     'WestJet', 'Porter Airlines', 'Air Transat', 'Swoop', 'Flair Airlines'
// ];

// const airports = [
//     'JFK', 'LAX', 'ORD', 'ATL', 'DFW', 'DEN', 'SFO', 'MIA', 'SEA',
//     'LAS', 'MCO', 'CLT', 'PHX', 'IAH', 'BOS', 'MSP', 'DTW', 'PHL',
...
//         const departureDate = addDays(new Date(), Math.floor(Math.random() * 30));
//         const departureTime = setHours(
//             setMinutes(departureDate, Math.floor(Math.random() * 60)),
...
//                 Math.floor((departureTime.getMinutes() + duration * 60) / 60)) %
//             24;
//         const finalArrivalTime = setHours(
//             setMinutes(arrivalTime, arrivalMinutes),
//             arrivalHours
//         );
//         const price = (Math.random() * 400 + 100).toFixed(2); // 100.00 to 500.00 USD //
